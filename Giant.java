...
public class Giant {
	...
	//constructor
	public Giant(double myHealth, double myStrength)
	{
		health = myHealth;
		strength = myStrength;
	}
	...
	{
		double temp = Math.random();//generates number between 0 and 1
		double attackVal = (temp * strength);//calculates attack val
		o.takeDamage(attackVal);//deals damage to ogre
